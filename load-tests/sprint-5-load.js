...
// Extends load-tests/sprint-3-load.js against the Sprint 5 system: same two
// scenarios, run for 60s instead of 30s (the sprint's minimum for the
// primary request path) so results are comparable to Sprint 3 at a longer
// duration, against the now fully-instrumented stack (RabbitMQ async path,
// inventory-service, health checks, Prometheus/Grafana).
